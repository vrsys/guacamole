...
IF ( NOT SCHISM_INCLUDE_DIRS )
	...
	SET(SCHISM_LARGE_DATA_SHADER_DIR ${_SCHISM_FOUND_INC_DIRS}/scm_large_data/src/scm/large_data/virtual_texture/shader CACHE PATH "path to schism large data shaders.")
    ...
    FOREACH(_INC_DIR ${_SCHISM_FOUND_INC_DIRS})
		...
		LIST(APPEND _SCHISM_INCLUDE_DIRS ${_INC_DIR}/scm_large_data/src)
