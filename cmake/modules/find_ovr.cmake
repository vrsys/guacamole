...
IF (MSVC)
	find_library(OVR_LIBRARY_RELEASE NAMES ovr.lib PATHS ${OVR_LIBRARY_SEARCH_DIRS} PATH_SUFFIXES release)
	find_library(OVR_LIBRARY_DEBUG NAMES ovr.lib ovrd.lib PATHS ${OVR_LIBRARY_SEARCH_DIRS} PATH_SUFFIXES debug)
ELSEIF (UNIX)
