...
if(0 == gl_InstanceID) {
  ...
  gua_normal         = (gua_secondary_normal_matrix * vec4(gua_in_normal, 0.0)).xyz;
  gua_tangent        = (gua_secondary_normal_matrix * vec4(gua_in_tangent, 0.0)).xyz;
  gua_bitangent      = (gua_secondary_normal_matrix * vec4(gua_in_bitangent, 0.0)).xyz;
  gua_texcoords      = gua_in_texcoords;
  gua_metalness      = 0.01;
  gua_roughness      = 0.1;
  gua_emissivity     = 0;
