...
void main()
{
    ...
    if (volume_type_id >= 0.9 && volume_type_id <= 20000.0)
    {
        ...
        vec3 gua_object_volume_position_front = (prim_r.origin + t_span.x * prim_r.direction) / (vtex_volume.texcoord_scale * volume_data.scale_obj_to_tex.xyz);
        ...
        gua_out_color = gbuffer_color * (1.0 - out_color.a) + out_color.rgb;
