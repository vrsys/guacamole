...
Mesh::Mesh(aiMesh* mesh, std::shared_ptr<Assimp::Importer> const& importer,
           bool build_kd_tree)
    : vertices_(),
      indices_(),
      vertex_array_(),
...
void Mesh::draw(RenderContext const& ctx) const {
...
void Mesh::ray_test(Ray const& ray, PickResult::Options options,
...
unsigned int Mesh::num_vertices() const { return mesh_->mNumVertices; }

////////////////////////////////////////////////////////////////////////////////

unsigned int Mesh::num_faces() const { return mesh_->mNumFaces; }

////////////////////////////////////////////////////////////////////////////////

scm::math::vec3 Mesh::get_vertex(unsigned int i) const {
...
std::vector<unsigned int> Mesh::get_face(unsigned int i) const {
