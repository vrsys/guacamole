...
//while traversal queue not empty and query queue not empty
    ...
    //while query queue not empty
        ...
        //if the first query is finished
            ...
            //n = pop query queue
            //handle returned query(n)

        //else

            //query next visible node from v-queue

    //if traversal queue is not empty

        //n = pop traversal queue

        //if n is inside the viewing frustrum

            //is n was not visible
    ...
    //if traversal queue is empty

        //issue multi queries


//while v-queue is not empty

    //issue query from v-queue
