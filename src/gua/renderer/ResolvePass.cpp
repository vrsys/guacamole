...
namespace gua {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  ResolvePassDescription& ResolvePassDescription::environment_lighting(std::string const& spheremap_texture) {
    uniforms["environement_lighting_spheremap"] = spheremap_texture;
    return *this;
  }

  ////////////////////////////////////////////////////////////////////////////////
  ResolvePassDescription& ResolvePassDescription::environment_lighting(std::string const& cube_map_positive_x,
  ...
  ResolvePassDescription& ResolvePassDescription::environment_lighting(utils::Color3f const& color) {
    uniforms["environment_lighting_color"] = gua::math::vec3(color.r(), color.g(), color.b());
    return *this;
  }

  ////////////////////////////////////////////////////////////////////////////////
  ResolvePassDescription& ResolvePassDescription::environment_lighting_method(EnvironmentLightingMode mode) {
    environment_lighting_mode_ = mode;
    return *this;
  }

  ////////////////////////////////////////////////////////////////////////////////
  ResolvePassDescription::EnvironmentLightingMode ResolvePassDescription::environment_lighting_method() const {
    return environment_lighting_mode_;
  }

  ////////////////////////////////////////////////////////////////////////////////
  ResolvePassDescription& ResolvePassDescription::mode(BackgroundMode mode) {
