...
std::string GuaMethodsFactory::get_sampler_casts() const {
    return R"(
...
std::string GuaMethodsFactory::get_material_id() const {
    return R"(
...
std::string GuaMethodsFactory::get_depth() const {
    return R"(
...
std::string GuaMethodsFactory::get_position() const {
    return R"(
