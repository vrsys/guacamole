...
void GBufferVolumeUberShader::create(std::set<std::string> const& material_names) {
  ...
  std::string vertex_shader(
    Resources::lookup_shader(Resources::shaders_uber_shaders_gbuffer_volume_volume_vert)
  );
  ...
  std::string fragment_shader(
    Resources::lookup_shader(Resources::shaders_uber_shaders_gbuffer_volume_volume_frag)
  );
