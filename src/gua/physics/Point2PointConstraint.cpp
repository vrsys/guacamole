...
Point2PointConstraint::Point2PointConstraint(RigidBodyNode* body_a,
                                             const math::vec3& pivot_a)
    : Constraint(body_a, nullptr), pivot_a_(pivot_a, false) {
  auto ct = new btPoint2PointConstraint(*(body_a->get_bullet_rigid_body()),
