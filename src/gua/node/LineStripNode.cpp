...
////////////////////////////////////////////////////////////////////////////////
std::string const& LineStripNode::get_geometry_description() const { return geometry_description_; }

////////////////////////////////////////////////////////////////////////////////
void LineStripNode::set_geometry_description(std::string const& v)
{
...
////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<Material> const& LineStripNode::get_material() const { return material_; }

////////////////////////////////////////////////////////////////////////////////
void LineStripNode::set_material(std::shared_ptr<Material> const& material)
{
    material_ = material;
...
void LineStripNode::ray_test_impl(Ray const& ray, int options, Mask const& mask, std::set<PickResult>& hits)
{
    /*
...
void LineStripNode::update_cache()
{
    ...
    if(geometry_changed_)
    {
        if(geometry_description_ != "")
        {
            ...
            geometry_ = std::dynamic_pointer_cast<LineStripResource>(GeometryDatabase::instance()->lookup(geometry_description_));

            if(!geometry_)
            {
                Logger::LOG_WARNING << "Failed to get LineStripResource for " << geometry_description_ << ": The data base entry is of wrong type!" << std::endl;
            }
        }
...
////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<LineStripResource> const& LineStripNode::get_geometry() const { return geometry_; }

////////////////////////////////////////////////////////////////////////////////
/* virtual */ void LineStripNode::accept(NodeVisitor& visitor) { visitor.visit(this); }

////////////////////////////////////////////////////////////////////////////////
void LineStripNode::update_bounding_box() const
{
    if(geometry_)
    {
...
////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<Node> LineStripNode::copy() const { return std::make_shared<LineStripNode>(*this); }
...
{
    push_vertex(line_strip_vertex.pos[0],
                line_strip_vertex.pos[1],
                line_strip_vertex.pos[2],
                line_strip_vertex.col[0],
                line_strip_vertex.col[1],
                line_strip_vertex.col[2],
                line_strip_vertex.col[3],
                line_strip_vertex.thick,
                line_strip_vertex.nor[0],
                line_strip_vertex.nor[1],
                line_strip_vertex.nor[2]);
};

////////////////////////////////////////////////////////////////////////////////
void LineStripNode::enqueue_vertex(float x, float y, float z, float col_r, float col_g, float col_b, float col_a, float thickness, float nor_x, float nor_y, float nor_z)
{
...
////////////////////////////////////////////////////////////////////////////////
void LineStripNode::push_vertex(float x, float y, float z, float col_r, float col_g, float col_b, float col_a, float thickness, float nor_x, float nor_y, float nor_z)
{
    if(nullptr != geometry_)
    {
        LineStrip::Vertex vertex_to_push(x, y, z, col_r, col_g, col_b, col_a, thickness, nor_x, nor_y, nor_z);
...
void LineStripNode::forward_queued_vertices()
{
    if(nullptr != geometry_)
    {
        geometry_->forward_queued_vertices(queued_positions_, queued_colors_, queued_thicknesses_, queued_normals_);
        update_bounding_box();
    }
}
