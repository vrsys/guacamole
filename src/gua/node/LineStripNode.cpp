...
namespace node {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  LineStripNode::LineStripNode(std::string const& name,
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::string const& LineStripNode::get_geometry_description() const {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::shared_ptr<Material> const& LineStripNode::get_material() const {
    return material_;
  }
  ...
  */
  ...
  void LineStripNode::update_cache() {
    ...
    if (geometry_changed_)
    {
      if (geometry_description_ != "")
      {
        ...
        if (!geometry_) {
          Logger::GUA_LOG_WARNING << "Failed to get LineStripResource for " << geometry_description_ << ": The data base entry is of wrong type!" << std::endl;
        }
      }
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /* virtual */ void LineStripNode::accept(NodeVisitor& visitor) {
    visitor.visit(this);
  }
