...
int main(int argc, char** argv)
{
    ...
    auto temporalSVOPipe = std::make_shared<gua::PipelineDescription>();
    temporalSVOPipe->add_pass(std::make_shared<gua::TriMeshPassDescription>());
    temporalSVOPipe->add_pass(std::make_shared<gua::TemporalSVOPassDescription>());
    temporalSVOPipe->add_pass(std::make_shared<gua::LightVisibilityPassDescription>());
    auto resolve_pass = std::make_shared<gua::ResolvePassDescription>();
    //resolve_pass->background_mode(gua::ResolvePassDescription::BackgroundMode::QUAD_TEXTURE);
    resolve_pass->tone_mapping_exposure(1.0f);

    temporalSVOPipe->add_pass(resolve_pass);
    temporalSVOPipe->set_enable_abuffer(false);
    ...
    camera->set_pipeline_description(temporalSVOPipe);
