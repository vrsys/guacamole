...
int main(int argc, char** argv) 
{
  ...
  std::string texture_file("/mnt/pitoti/hallermann_scans/Scherkondetalbruecke2/Pfeiler_nochmal/3D_Modell_Pfeiler_Scherkodetal_midres/lowres/3D_Modell_Pfeiler_Scherkodetal_midres_single_textured.jpg");
  ...
  auto mlod_node = lod_loader.load_lod_trimesh("tri_mesh", tri_mesh_file.c_str(), mat_textured,
