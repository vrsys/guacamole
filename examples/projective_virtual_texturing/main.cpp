...
int main(int argc, char** argv) {
  ...
  auto monkey(loader.create_geometry_from_file("receiving_object", "data/objects/vive_controller.obj", projective_material, gua::TriMeshLoader::NORMALIZE_POSITION | gua::TriMeshLoader::NORMALIZE_SCALE));
