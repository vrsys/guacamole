...
#ifndef GUA_TEXTURED_SCREEN_SPACE_QUAD_NODE_HPP
#define GUA_TEXTURED_SCREEN_SPACE_QUAD_NODE_HPP
 ...
 *
 * A TexturedScreenSpaceQuadNode is capable of displaying any texture and even Pipeline
...
class GUA_DLL TexturedScreenSpaceQuadNode : public SerializableNode {
 ...
 public:
  ...
  struct Configuration {
    ...
    GUA_ADD_PROPERTY(float,       fake_parallax, 0.f);
