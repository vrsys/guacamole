...
class GUA_DLL PipelinePassPrivate
{
  public:
    ...
    std::function<void(PipelinePass&, PipelinePassDescription const&, Pipeline&, bool, bool)> process_;
};
...
class GUA_DLL PipelinePass
{
  public:
    ...
    void process(PipelinePassDescription const& desc, Pipeline& pipe, bool render_multiview, bool use_hardware_mvr);
