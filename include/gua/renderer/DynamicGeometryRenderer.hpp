...
#ifndef GUA_DYNAMIC_GEOMETRY_RENDERER_HPP
#define GUA_DYNAMIC_GEOMETRY_RENDERER_HPP
...
{
  public:
    DynamicGeometryRenderer(RenderContext const& ctx, SubstitutionMap const& smap);
...
#endif // GUA_DYNAMIC_GEOMETRY_RENDERER_HPP
