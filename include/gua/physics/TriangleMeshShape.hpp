...
namespace HACD { template <typename T> class Vec3; }
...
class GUA_DLL TriangleMeshShape : public CollisionShape {
 public:
   ...
   */
  TriangleMeshShape()
      : CollisionShape(false, false, false),
        concave_tri_mesh_(nullptr),
        concave_shape_(nullptr),
        scaling_(math::vec3(1.f, 1.f, 1.f)),
        hacd_min_clusters(2),
        hacd_max_ch_vertices(100),
        hacd_concavity(80),
        hacd_add_extra_dist_points(false),
        hacd_add_neighbours_dist_points(false),
        hacd_add_faces_points(false) {}
   ...
   */
  void build_from_geometry_static(
   ...
   */
  void build_from_geometry_dynamic(
      const std::vector<std::string>& geometry_list);
   ...
   */
  static TriangleMeshShape* FromGeometry(
      const std::vector<std::string>& geometry_list,
      bool build_static,
      bool build_dynamic);
