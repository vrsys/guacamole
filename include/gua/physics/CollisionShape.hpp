...
class GUA_DLL CollisionShape {
 ...
 public:
   ...
   */
  explicit CollisionShape(bool static_shape,
                          bool dynamic_shape,
                          bool identical_shape_contructor)
      : is_static_shape_(static_shape),
        is_dynamic_shape_(dynamic_shape),
        has_identical_shape_constructor_(identical_shape_contructor) {}
  ...
  void set_is_static_shape(bool is_static_shape) {
    is_static_shape_ = is_static_shape;
  }
  ...
  void set_is_dynamic_shape(bool is_dynamic_shape) {
   ...
   */
  bool has_identical_shape_constructor() const {
 ...
 protected:
  ...
  virtual void construct_dynamic(btCompoundShape* bullet_shape,
                                 const btTransform& base_transform) = 0;
