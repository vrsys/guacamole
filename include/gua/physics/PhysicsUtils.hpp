...
inline btVector3 const math::vec3_to_btVector3(const math::vec3& vec) {
...
inline btTransform const math::mat4_to_btTransform(const math::mat4& m) {
  return btTransform(
      btMatrix3x3(
          m.m00, m.m04, m.m08, m.m01, m.m05, m.m09, m.m02, m.m06, m.m10),
      btVector3(m.m12, m.m13, m.m14));
}
...
inline btQuaternion const math::extract_quaternion(const math::mat4& m) {
  ...
  float q[4];
  int i, j, k;
  float mat[4][4] = { { m.m00, m.m01, m.m02, m.m03 },
                      { m.m04, m.m05, m.m06, m.m07 },
                      { m.m08, m.m09, m.m10, m.m11 },
