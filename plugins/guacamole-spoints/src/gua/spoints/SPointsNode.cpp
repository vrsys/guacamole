...
/////////////////////////////////////////////////////////////////////////////
SPointsNode::SPointsNode(std::string const& name,
	                       std::string const& spoints_description,
...
void SPointsNode::ray_test_impl(Ray const& ray,
                                int options,
                                Mask const& mask,
...
/* virtual */ void SPointsNode::accept(NodeVisitor& visitor) {
  visitor.visit(this);
}

/////////////////////////////////////////////////////////////////////////////
std::string const& SPointsNode::get_spoints_description() const {
  return spoints_description_;
}
...
////////////////////////////////////////////////////////////////////////////////
void SPointsNode::force_reload(){
  spoints_changed_ = true;
}

////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<Material> const& SPointsNode::get_material() const {
  return material_;
}
...
std::shared_ptr<Node> SPointsNode::copy() const {
  return std::make_shared<SPointsNode>(*this);
}
	...
	if (spoints_changed_) {
		if (spoints_description_ != "") {
          ...
          Logger::LOG_WARNING
			...
			spoints_ = std::dynamic_pointer_cast<SPointsResource>(
