...
PLODNode::PLODNode(std::string const& name,
    ...
    : GeometryNode(name, transform), geometry_(nullptr), geometry_changed_(true), geometry_description_(geometry_description), geometry_file_path_(geometry_file_path), material_(material),
      radius_scale_(scale), error_threshold_(threshold), enable_backface_culling_by_normal_(enable_backface_culling_by_normal)
{
}

////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<PLODResource> const& PLODNode::get_geometry() const { return geometry_; }
...
////////////////////////////////////////////////////////////////////////////////
float PLODNode::get_radius_scale() { return radius_scale_; }
...
////////////////////////////////////////////////////////////////////////////////
float PLODNode::get_error_threshold() { return error_threshold_; }
...
////////////////////////////////////////////////////////////////////////////////
bool PLODNode::get_enable_backface_culling_by_normal() { return enable_backface_culling_by_normal_; }
