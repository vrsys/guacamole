...
namespace gua
{
Video3DPassDescription::Video3DPassDescription() : PipelinePassDescription()
{
...
std::shared_ptr<PipelinePassDescription> Video3DPassDescription::make_copy() const { return std::make_shared<Video3DPassDescription>(*this); }
