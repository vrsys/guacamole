...
{
//////////////////////////////////////////////////////////////////////////////
TemporalSVORenderer::TemporalSVORenderer(gua::RenderContext const& ctx, gua::SubstitutionMap const& substitution_map)
...
/////////////////////////////////////////////////////////////////////////////////////////////
void TemporalSVORenderer::_load_shaders()
{
...
/*
void TemporalSVORenderer::_initialize_ray_casting_program(
...
std::shared_ptr<ShaderProgram> TemporalSVORenderer::_get_material_program(MaterialShader* material,
...
///////////////////////////////////////////////////////////////////////////////
void TemporalSVORenderer::_create_gpu_resources(gua::RenderContext const& ctx, scm::math::vec2ui const& render_target_dims)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
void TemporalSVORenderer::_check_for_resource_updates(gua::Pipeline const& pipe, RenderContext const& ctx)
{
...
///////////////////////////////////////////////////////////////////////////////
void TemporalSVORenderer::render(gua::Pipeline& pipe, PipelinePassDescription const& desc)
{
    ...
    //  sort nodes
    ///////////////////////////////////////////////////////////////////////////
    auto sorted_objects(scene.nodes.find(std::type_index(typeid(node::TemporalSVONode))));


    std::cout << "Rendering TemporalSVOPass" << std::endl;
    ...
    std::sort(sorted_objects->second.begin(), sorted_objects->second.end(), [](node::Node* a, node::Node* b) {
        return reinterpret_cast<node::TemporalSVONode*>(a)->get_material()->get_shader() < reinterpret_cast<node::TemporalSVONode*>(b)->get_material()->get_shader();
    });
