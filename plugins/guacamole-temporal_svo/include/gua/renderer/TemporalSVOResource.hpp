...
#ifndef GUA_TEMPORAL_SVO_RESOURCE_HPP
#define GUA_TEMPORAL_SVO_RESOURCE_HPP
...
/**
 * Stores a Temporal SVO model.
 *
 * This class simply a wrapper for accessing models from the Temporal SVO library
 */
class TemporalSVOResource : public GeometryResource
{
  public:
  ...
  public: // c'tor /d'tor
    ...
    TemporalSVOResource(std::string const& resource_file_string, bool is_pickable);
  ...
  public: // methods
    ...
    /**
     * Draws a timestep of the temporal SVO.
     *
     * Draws a timestep of the temporal SVO to the given context.
     *
...
#endif // GUA_TEMPORAL_SVO_RESSOURCE_HPP
