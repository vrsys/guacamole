...
////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<LodResource> const& MLodNode::get_geometry() const {
  return geometry_;
}
...
////////////////////////////////////////////////////////////////////////////////
std::string const& MLodNode::get_geometry_file_path() const {
  return geometry_file_path_;
}

////////////////////////////////////////////////////////////////////////////////
std::string const& MLodNode::get_geometry_description() const {
...
////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<Material> const& MLodNode::get_material() const {
  return material_;
}
...
////////////////////////////////////////////////////////////////////////////////
float MLodNode::get_error_threshold() {
  return error_threshold_;
}

////////////////////////////////////////////////////////////////////////////////
void MLodNode::ray_test_impl(Ray const& ray,
                             int options,
                             Mask const& mask,
...
////////////////////////////////////////////////////////////////////////////////
/* virtual */ void MLodNode::accept(NodeVisitor& visitor) {
  visitor.visit(this);
}
