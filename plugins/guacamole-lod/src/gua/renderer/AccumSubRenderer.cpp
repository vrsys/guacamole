...
namespace gua {
  ...
  AccumSubRenderer::AccumSubRenderer() : PLodSubRenderer(){
  	_load_shaders();
  }
...
#error "This works only with GUACAMOLE_RUNTIME_PROGRAM_COMPILATION enabled"
  ...
  void AccumSubRenderer::_upload_model_dependent_uniforms(std::shared_ptr<ShaderProgram> current_material_shader, 
