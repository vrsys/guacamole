...
namespace gua {
  ...
  PLodSubRenderer::PLodSubRenderer() : shader_program_(nullptr), 
  ...
  std::shared_ptr<ShaderProgram> PLodSubRenderer::_get_material_dependent_shader_program(MaterialShader* material,
