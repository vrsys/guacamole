...
#ifndef GUA_HOLE_FILLING_SUB_RENDERER_HPP
#define GUA_HOLE_FILLING_SUB_RENDERER_HPP
...
#include <gua/renderer/PLodSubRenderer.hpp>
 ...
 namespace gua {
  ...
  class GUA_LOD_DLL HoleFillingSubRenderer : public PLodSubRenderer {

  public:
  	HoleFillingSubRenderer();
  ...
  private: //shader related auxiliary methods
    ...
    virtual void _upload_hole_filling_pass_uniforms(RenderContext const& ctx, 
                                                     gua::plod_shared_resources& shared_resources);
  private:
 ...
 #endif //GUA_HOLE_FILLING_SUB_RENDERER_HPP