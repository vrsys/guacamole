...
#ifndef GUA_LOW_QUALITY_SPLATTING_SUB_RENDERER_HPP
#define GUA_LOW_QUALITY_SPLATTING_SUB_RENDERER_HPP
...
#include <gua/renderer/PLodSubRenderer.hpp>
 ...
 namespace gua {
  ...
  class GUA_LOD_DLL LowQualitySplattingSubRenderer : public PLodSubRenderer {

  public:
  	LowQualitySplattingSubRenderer();
  ...
  private: //shader related auxiliary methods
    ...
    void _upload_model_dependent_uniforms(std::shared_ptr<ShaderProgram> const& current_material_shader,
                                          RenderContext const& ctx, node::PLodNode* plod_node, gua::Pipeline& pipe);
  private:
    scm::gl::rasterizer_state_ptr   no_backface_culling_rasterizer_state_;
  };
 } 

 #endif //GUA_LOW_QUALITY_SPLATTING_SUB_RENDERER_HPP