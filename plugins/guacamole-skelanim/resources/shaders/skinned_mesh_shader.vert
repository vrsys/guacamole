...
void main() {
  ...
  gua_world_position  = (gua_model_matrix * BoneTransform * vec4(gua_in_position, 1.0)).xyz;
  gua_view_position  = (gua_model_view_matrix * BoneTransform * vec4(gua_in_position, 1.0)).xyz;
